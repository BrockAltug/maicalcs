...
export default function CircumferenceCalculatorPage() {
  ...
  const calculateCircumference = () => {
    try {
      ...
      setResults({
        ...
        formula: `C = 2πr = 2π × ${radius.toFixed(2)}`,
      })
    } catch (error) {
        ...
        <div className="container mx-auto text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              Calculate the circumference of a circle from radius, diameter, or area with MaiCalcs. Perfect for geometry
              problems and real-world measurements.
            </p>
          </div>
        </div>
      </section>
            ...
            <Card className="shadow-2xl border-0">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex space-x-4">
                  <Button onClick={calculateCircumference} className="flex-1 bg-blue-600 hover:bg-blue-700">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="mt-6 p-4 bg-gray-50 rounded-lg">
                      ...
                      <div className="text-sm text-gray-700 space-y-1">
                        <p>• Wheel and tire measurements</p>
                        <p>• Circular track distances</p>
                        <p>• Pipe and cable calculations</p>
                        <p>• Garden and landscaping design</p>
                      </div>
                    </div>
                  </div>
                ) : (
