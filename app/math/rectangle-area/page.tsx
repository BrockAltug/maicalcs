...
export default function RectangleAreaCalculatorPage() {
        ...
        <div className="container mx-auto text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              Calculate the area of a rectangle from length and width with MaiCalcs. Perfect for flooring, room
              ...
              <CardContent className="space-y-6">
                ...
                <div className="bg-green-50 rounded-lg p-4">
                  ...
                  <div className="text-sm text-green-700 space-y-1">
                    <p>• l = 5cm, w = 3cm → A = 15cm²</p>
                    <p>• l = 10m, w = 6m → A = 60m²</p>
                    <p>• l = 8in, w = 4in → A = 32in²</p>
                  </div>
                </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="mt-6 p-4 bg-gray-50 rounded-lg">
                      ...
                      <div className="text-sm text-gray-700 space-y-1">
                        <p>• Flooring and carpet calculations</p>
                        <p>• Paint coverage estimation</p>
                        <p>• Room and space planning</p>
