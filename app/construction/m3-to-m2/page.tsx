...
export default function M3ToM2ConverterPage() {
        ...
        <div className="container mx-auto text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              Convert a volume in cubic meters (m³) to an area in square meters (m²) by providing a thickness or depth.
            </p>
          </div>
        </div>
      </section>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="bg-orange-50 rounded-lg p-4">
                  ...
                  <div className="text-sm text-orange-700 space-y-1">
                    <p>• Calculates area (m²) from volume (m³) and thickness (m).</p>
                ...
                <div className="bg-green-50 rounded-lg p-4">
                  ...
                  <div className="text-sm text-green-700 space-y-1">
                    <p>• Spreading gravel: Volume of gravel / depth</p>
                    <p>• Pouring concrete: Volume of concrete / slab thickness</p>
                    <p>• Calculating footprint: Volume of object / height</p>
                  </div>
                </div>
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <div className="flex items-center space-x-2">
                          <span className="text-xl font-bold text-orange-600 font-mono">
                            {results.area.toFixed(3)} m²
                          </span>
                          <Button
                            variant="ghost"
                            size="sm"
                            onClick={() => copyResult(`${results.area.toFixed(3)} m²`)}
